...
4. Ако нещо ново се е задействало, праща едно консолидирано WhatsApp съобщение: текуща цена (последно 5м затваряне), близка съпротива/подкрепа (най-висока/ниска от последните 20 1ч свещи), лонг/шорт съотношение (Binance global account ratio, 1ч) и списъка на задействалите се сигнали.
